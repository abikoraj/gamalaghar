...
!(function (t) {
    ...
    function o(o, _) {
        ...
        if (
            (void 0 !== _.regexpMatchFormat &&
                ...
                ((window["regexpMatchFormat_" + o.attr("id")] =
                    _.regexpMatchFormat),
                (window["regexpReplaceWith_" + o.attr("id")] =
                    _.regexpReplaceWith)),
            ...
            if (
                ...
                void 0 !== _.beforeExpiryTime &&
                    (window["beforeExpiry_withStart" + o.attr("id")] =
                        M.beforeExpiryTime),
                    c(o, M, "withStart"),
                    (window["timer_startDate" + o.attr("id")] = setInterval(
                        function () {
                            c(o, M, "withStart");
                        },
                        1e3 * M.tickInterval
                ...
                void 0 !== _.beforeExpiryTime &&
                    (window["beforeExpiry_withnoStart" + o.attr("id")] =
                        M.beforeExpiryTime),
                    c(o, M, "withnoStart"),
                    (window["timer_givenDate" + o.attr("id")] = setInterval(
                        function () {
                            c(o, M, "withnoStart");
                        },
                        1e3 * M.tickInterval
                ...
                void 0 !== _.currentTime && !0 === M.currentTime
                    ...
                    : ((window["countSeconds" + o.attr("id")] = M.seconds),
                      m(o, M),
                      (window["timer_secondsTimer" + o.attr("id")] =
    ...
    function n(t, o, n, e, i) {
        t.data("typefunc", { type: o, func: e }),
            ...
            void 0 !== i.beforeExpiryTime &&
                (window["beforeExpiry_" + o + t.attr("id")] =
                    n.beforeExpiryTime),
    ...
    function w(t, o) {
        var n = t.attr("id"),
            e = "";
        window["minutes_HM" + n] === o.minutes &&
        window["hours_HM" + n] === o.hours
            ? (v(
                  t,
                  (e = S(
                      t,
    ...
    function a(t, o) {
        var n = t.attr("id"),
            e = "";
        window["seconds_HS" + n] === o.seconds &&
        window["hours_HS" + n] === o.hours
            ? (v(
                  t,
                  (e = S(
                      t,
    ...
    function S(t, o, n, e, i, d, s, w) {
        ...
        var r =
            ...
            c =
                "!" === a[1]
                    ? Math.round(
                          Math.floor(r / 2628e3 - (31536e3 * u) / 2628e3)
                      )
                    : 0,
            l =
                "!" === a[2]
                ...
                "resume" != t(this).val()
                    ...
                    : "resume" == t(this).val() &&
                      (t("#" + e.pauseButton)
                          .val("pause")
                          .text("Pause"),
                      (window["timer_" + n + o.attr("id")] = setInterval(
                          function () {
                              i(o, e);
                          },
                          1e3 * e.tickInterval
    ...
    (t.fn.countdowntimer = function (o) {
        return f[o]
            ...
            : "object" != typeof o && o
            ? void t.error(
                  "Method " + o + " does not exist on jQuery.countdownTimer"
              )
            : (this.data(
                  "countdowntimer",
