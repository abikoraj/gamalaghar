<div>
    <form wire:submit.prevent="save">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-lg-6">
                <div class="form-group">
                    <input type="text" name="email" id="email" placeholder="Enter your email" wire:model.live="email">
                     @error('email')
                <p class="text-danger">{{$message}}</p>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-lg-6">
                <div class="form-group">
                    <input type="tel" name="number" id="number" placeholder="Phone Number" wire:model.live="phone_no">
                     @error('phone_no')
                <p class="text-danger">{{$message}}</p>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6">
                <div class="form-group">
                    <div class="form-group">
                        <input type="text" name="subject" id="subject" placeholder="Subject" wire:model.live="subject">
                         @error('subject')
                <p class="text-danger">{{$message}}</p>
